...
// AddPluginToManifest - Add a plugin to the manifest file and update it
...
// InstallPlugins - Reconcile the manifest to the lock file, and then the lock file to the disk
