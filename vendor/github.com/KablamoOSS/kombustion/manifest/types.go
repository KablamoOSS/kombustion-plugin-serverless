...
type Manifest struct {
	...
	Plugins map[string]ManifestPlugin `yaml:"plugins,omitempty"`
	...
	Environments map[string]ManifestEnvironment `yaml:"environments,omitempty"`
...
// ManifestPlugins - Plugin specification inside the manifest
...
// ManifestEnvironment - Environment specific parameters
